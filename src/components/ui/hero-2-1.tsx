        ...
        <nav className="container mx-auto flex items-center justify-between px-4 py-4 mt-6">
          ...
          <div className="hidden md:flex items-center space-x-6">
            <div className="flex items-center space-x-3">
              <button className="cursor-pointer h-12 rounded-full bg-white px-8 text-base font-medium text-black hover:bg-white/90">
                Login
              </button>
            </div>
          </div>
          ...
          {mobileMenuOpen && (
            ...
            >
              ...
              <div className="mt-8 flex flex-col space-y-6">
                <div className="pt-4">
                  <button className="cursor-pointer w-full justify-start border border-gray-700 text-white">
                    Log in
                  </button>
                </div>
                <button className="cursor-pointer h-12 rounded-full bg-white px-8 text-base font-medium text-black hover:bg-white/90">
